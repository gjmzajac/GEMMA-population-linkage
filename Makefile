...
ifdef FORCE_DYNAMIC
LIBS = -lgsl -lgslcblas -lblas -pthread -lz -lsqlite3 -ldl
else
LIBS = -lgsl -lgslcblas -pthread -lz -lsqlite3 -ldl
endif
...
# GJMZ added
LIBS_LNX_S_LAPACK = -llapack -lgfortran -latlas /usr/lib/libblas/libblas.a -Wl,--allow-multiple-definition -lquadmath
# LIBS_LNX_S_LAPACK = -llapack -lgfortran /net/wonderland/home/gzajac/lib/atlas/lib/libatlas.a /usr/lib/libblas/libblas.a -Wl,--allow-multiple-definition -lquadmath

# Options

ifdef FORCE_FLOAT
  CPPFLAGS += -DFORCE_FLOAT
  SOURCES += $(SRC_DIR)/param_float.cpp $(SRC_DIR)/gemma_float.cpp $(SRC_DIR)/io_float.cpp $(SRC_DIR)/lm_float.cpp $(SRC_DIR)/vc_float.cpp $(SRC_DIR)/lmm_float.cpp $(SRC_DIR)/mvlmm_float.cpp $(SRC_DIR)/bslmm_float.cpp $(SRC_DIR)/prdt_float.cpp $(SRC_DIR)/mathfunc_float.cpp $(SRC_DIR)/gzstream.cpp $(SRC_DIR)/eigenlib_float.cpp $(SRC_DIR)/ldr_float.cpp $(SRC_DIR)/bslmmdap_float.cpp $(SRC_DIR)/logistic_float.cpp $(SRC_DIR)/varcov_float.cpp $(SRC_DIR)/Segments.cpp
  HDR += $(SRC_DIR)/param_float.h $(SRC_DIR)/gemma_float.h $(SRC_DIR)/io_float.h $(SRC_DIR)/lm_float.h $(SRC_DIR)/lmm_float.h $(SRC_DIR)/vc_float.h $(SRC_DIR)/mvlmm_float.h $(SRC_DIR)/bslmm_float.h $(SRC_DIR)/prdt_float.h $(SRC_DIR)/mathfunc_float.h $(SRC_DIR)/gzstream.h $(SRC_DIR)/eigenlib_float.h $(SRC_DIR)/Segments.h
else
  ...
  HDR += $(SRC_DIR)/param.h $(SRC_DIR)/gemma.h $(SRC_DIR)/io.h $(SRC_DIR)/lm.h $(SRC_DIR)/lmm.h $(SRC_DIR)/vc.h $(SRC_DIR)/mvlmm.h $(SRC_DIR)/bslmm.h $(SRC_DIR)/prdt.h $(SRC_DIR)/mathfunc.h $(SRC_DIR)/gzstream.h $(SRC_DIR)/eigenlib.h $(SRC_DIR)/Segments.h
endif
