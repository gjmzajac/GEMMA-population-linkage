...
public:
  ...
  size_t a_mode;
	...
	void Calc2VCheMulti (const gsl_matrix *K_scale, vector<double> &traceG_new, const gsl_vector *y_scale, double var_y, double var_y_new, gsl_matrix * &Kry, gsl_vector * &q_vec, gsl_matrix * &yKrKKry, gsl_matrix * &S_mat); //GJMZ added
